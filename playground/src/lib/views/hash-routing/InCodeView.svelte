...
<div>
    <h1><i class="bi bi-code-slash"></i> In-Code Hash Routing</h1>
    <p class="lead">
    ...
    <div class="row mt-4">
        <div class="col-xl-4 col-lg-6">
            <Card border="primary" class="h-100">
                ...
                <CardBody>
                    <p>
                        Hash routing is perfect for single-page applications. It works without
                        server configuration and plays nicely with static hosting!
                    </p>
                    <CodeSnippet
                        language={xml}
        ...
        <div class="col-xl-4 col">
            <Card border="danger" class="h-100">
                ...
                <CardBody>
                    <p>
                        You should always stick to <code>Link</code> components when creating navigation
                        links. However, hash HREF's in anchor elements work:
                    </p>
                    <CodeSnippet
                        language={typescript}
                    ...
                    <Alert background="info">
                        ℹ️ Anchor elements, when clicked, carry the existing history state.
                    </Alert>
    ...
    <div class="row mt-4">
        <div class="col-lg-6">
            <Card border="warning" class="h-100">
                ...
                <CardBody>
                    <p>
                        Run multiple independent hash routers simultaneously! Each router gets its
                        own namespace in the hash value using key-value pairs.
                    </p>
                    <CodeSnippet
                        language={xml}
                    ...
                    <div class="alert alert-success mt-2">
                        <strong>💡 Pro tip:</strong> Keep your multi-hash path names short to prevent
                        URLs from growing too long!
                    </div>
                </CardBody>
            </Card>
        </div>
            ...
            <Card border="info" class="h-100">
                ...
                <CardBody>
                    ...
                    <div class="alert alert-success mt-3">
                        <strong>Best practice:</strong> Use path routing for main content and hash routing
                        for overlays and temporary UI states.
                    </div>
                </CardBody>
            </Card>
        </div>
