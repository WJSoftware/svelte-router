            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <ul class="mb-0 mt-2">
                            <li>
                                <code>location.url.hash</code>
                                <Badge background="success">reactive</Badge> updates automatically
                            </li>
                            <li>
                                <code>location.hashPaths</code>
                                <Badge background="success">reactive</Badge> provides parsed hash routes
                            </li>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick={() => location.back()}>
                        Got it! 👍
                    </button>
                </div>
            </div>
