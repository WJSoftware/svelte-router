...
<div class="container">
    ...
    <p class="lead">
        The classic way to navigate! Path routing uses the URL path to determine which components to
        render, just like traditional web applications but with SPA speed and smoothness.
    </p>
    ...
    <div class="row mt-4">
        <div class="col-lg-6">
            <Card border="primary" class="h-100">
                ...
                <CardBody>
                    <p>
                        Path routing is the default mode in <code>@svelte-router/core</code>. It
                        feels natural because it works just like regular websites - but faster!
                    </p>
                    <CodeSnippet
                        language={xml}
        ...
        <div class="col-lg-6">
            <Card border="success" class="h-100">
                <CardHeader background="success" textColor="white" tag="h4"
                    >🔗 Link Components</CardHeader
                >
                <CardBody>
                    <p>
                        Replace <code>&lt;a&gt;</code> tags with <code>&lt;Link&gt;</code> components
                    ...
                    <div class="alert alert-warning mt-3">
                        <strong>Important:</strong> Regular anchor tags will cause full page
                        reloads. Always use
                        <code>&lt;Link&gt;</code> for internal navigation!
                    </div>
                </CardBody>
            </Card>
        </div>
            ...
            <Card border="warning" class="h-100">
                ...
                <CardBody>
                    ...
                    <div class="alert alert-success mt-3">
                        <strong>Pro tip:</strong> Use rest parameters (<code>/*</code>) for file
        ...
        <div class="col-lg-6">
            <Card border="info" class="h-100">
                ...
                <CardBody>
                    ...
                    />
                    <div class="alert alert-info mt-3">
                        <strong>Powerful:</strong> Each router can have its own
                        <code>basePath</code>
    ...
    <div class="row mt-4">
                ...
                <CardBody>
                    ...
                    <div class="mt-3">
                        <small class="text-muted">
                            💡 Notice how parameters and rest routes capture dynamic parts of the
                            URL!
                        </small>
                    </div>
                </CardBody>
        ...
        <div class="col-lg-6">
            <Card border="dark" class="h-100">
                <CardHeader background="dark" textColor="white" tag="h4">🛡️ Route Guards</CardHeader
                >
                <CardBody>
                    <p>
                        Control access to routes with the <code>and</code> property. Perfect for authentication
                        and authorization!
                    </p>
                    <CodeSnippet
                        language={xml}
                    ...
                    <div class="alert alert-danger mt-3">
                        <strong>Security:</strong> Route guards help protect sensitive areas but always
                        validate permissions on the server too!
                    </div>
                </CardBody>
            </Card>
        </div>
            ...
            <Card border="success">
                ...
                <CardBody>
                    ...
                    <div class="text-center mt-4">
                        <p class="lead mb-0">
                            <strong>The best of both worlds:</strong> Traditional web navigation with
    ...
    <div class="row mt-5">
        <div class="col-lg-10 offset-lg-1">
            <div class="alert alert-primary text-center">
                ...
                <p class="mb-3">
                    Click the "Start Demo" link in the navigation above to see path routing in
                    action! Watch how the URL changes as you navigate between different sections.
                </p>
                <p class="mb-0">
                    <strong>Pro tip:</strong> Open your browser's developer tools and watch the Network
                    tab - notice how no full page requests are made when navigating! 🎉
                </p>
            </div>
        </div>
    </div>
