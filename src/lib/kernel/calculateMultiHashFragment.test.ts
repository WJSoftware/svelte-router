...
describe('calculateMultiHashHref', () => {
    ...
    describe('Basic functionality', () => {
        beforeEach(() => {
            ...
            location.url.href =
                'https://example.com#p1=/initial/path;p2=/another/path;p3=/third/path';
        });
        ...
        test('Should add new hash paths not present in existing paths.', () => {
            ...
            // Assert
            expect(result).toBe(
                'p1=/initial/path;p2=/another/path;p3=/third/path;p4=/new/hash/path;p5=/another/new/path'
            );
        });
        ...
        test('Should handle combination of preserving, updating, and adding paths.', () => {
            ...
            // Assert
            expect(result).toBe(
                'p1=/initial/path;p2=/updated/existing;p3=/third/path;p4=/brand/new;p6=/another/new'
            );
        });
    });
    ...
    describe('Path value handling', () => {
        ...
        test('Should handle complex nested paths.', () => {
            ...
            // Assert
            expect(result).toBe(
                'p1=/users/123/profile/edit;p2=/admin/settings/permissions/advanced'
            );
        });
    ...
    describe('Empty string path removal', () => {
        beforeEach(() => {
            location.url.href =
                'https://example.com#p1=/existing/path;p2=/another/existing;p3=/third/existing';
        });
        ...
        test('Should preserve order when some paths are removed via empty strings.', () => {
            // Arrange
            location.url.href =
                'https://example.com#a=/path/a;b=/path/b;c=/path/c;d=/path/d;e=/path/e';
    ...
    describe('Hash ID handling', () => {
        ...
        test('Should handle various hash ID formats.', () => {
            ...
            // Assert
            expect(result).toBe(
                'main=/updated/main;secondary=/secondary/path;my-hash=/new/dash;my_hash=/new/underscore;hash123=/numeric/suffix'
            );
        });
        ...
        test('Should handle single character hash IDs.', () => {
            ...
            // Assert
            expect(result).toBe(
                'main=/main/path;secondary=/secondary/path;a=/path/a;x=/path/x;z=/path/z'
            );
        });
    });
    ...
    describe('Order preservation', () => {
        test('Should maintain existing path order and append new paths in input order.', () => {
            ...
            expect(result).toBe(
                'zebra=/z/path;alpha=/updated/a/path;beta=/b/path;gamma=/g/path;delta=/d/path'
            );
        });
    ...
    describe('Cross-universe redirection use cases', () => {
        test('Should support clearing a source universe path while setting target universe path.', () => {
            ...
            location.url.href =
                'https://example.com#source=/current/source/path;target=/current/target/path';
        ...
        test('Should support updating multiple universes simultaneously for complex redirection scenarios.', () => {
            // Arrange
            location.url.href =
                'https://example.com#main=/main/current;sidebar=/sidebar/current;modal=/modal/current';
            ...
            expect(result).toBe(
                'main=/main/redirected;modal=/modal/new;notifications=/notifications/init'
            );
        });
    });
});
