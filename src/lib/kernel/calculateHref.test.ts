...
describe('calculateHref', () => {
    ...
    describe('HREF Validation', () => {
        ...
        test('Should reject HREF with http protocol', () => {
            expect(() => calculateHref('http://example.com/path')).toThrow(
                'HREF cannot contain protocol, host, or port. Received: "http://example.com/path"'
            );
        });

        test('Should reject HREF with https protocol', () => {
            expect(() => calculateHref('https://example.com/path')).toThrow(
                'HREF cannot contain protocol, host, or port. Received: "https://example.com/path"'
            );
        });

        test('Should reject HREF with ftp protocol', () => {
            expect(() => calculateHref('ftp://example.com/path')).toThrow(
                'HREF cannot contain protocol, host, or port. Received: "ftp://example.com/path"'
            );
        });

        test('Should reject HREF with protocol-relative URL', () => {
            expect(() => calculateHref('//example.com/path')).toThrow(
                'HREF cannot contain protocol, host, or port. Received: "//example.com/path"'
            );
        });

        test('Should reject HREF with custom protocol', () => {
            expect(() => calculateHref('custom-protocol://example.com/path')).toThrow(
                'HREF cannot contain protocol, host, or port. Received: "custom-protocol://example.com/path"'
            );
        });
        ...
        test('Should reject HREF among multiple valid paths', () => {
            expect(() =>
                calculateHref('/valid/path', 'https://example.com/invalid', '/another/valid')
            ).toThrow(
                'HREF cannot contain protocol, host, or port. Received: "https://example.com/invalid"'
            );
        });
    ...
    describe('Integration with calculateMultiHashHref', () => {
        ...
        test('Should call calculateMultiHashHref when hash is a string (named hash routing)', () => {
            // Arrange
            const spy = vi
                .spyOn(calculateMultiHashHrefModule, 'calculateMultiHashFragment')
                .mockReturnValue('p1=/new/path;p2=/another/path');
        ...
        test('Should pass correct parameters to calculateMultiHashHref with joined paths', () => {
            ...
            const spy = vi
                .spyOn(calculateMultiHashHrefModule, 'calculateMultiHashFragment')
                .mockReturnValue('p1=/path1/path2;p2=/another/path');
