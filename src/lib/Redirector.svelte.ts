...
export class Redirector {
     ...
     */
    #routePatterns = $derived.by(() =>
        this.redirections.map((url) => this.#routeHelper.parseRoutePattern(url))
    );
    /**
     ...
     */
    #navigate(
        redirection: RedirectedRouteInfo,
        routeParams: Record<string, ParameterValue> | undefined
    ) {
        const url =
            typeof redirection.href === 'function'
